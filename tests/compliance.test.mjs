...
import { complianceCalendar, dueDatesFor, headcountThresholds, monthlyRemittanceDeadlines, pagibigDueDay, parseDueRule, philhealthDueDay, rollForward, yearEndDeadlines } from "../lib/utils/compliance.ts";
...
describe("dueDatesFor", () => {
  ...
  it("quarterly: 1702Q 60 days after Q1-Q3 only; 2551Q the 25th after every quarter; 1601-EQ month-end", () => {
    ...
    assert.equal(q[1].dueOn, "2026-08-31"); // Jun 30 + 60 = Aug 29 (Sat) -> Aug 31
...
describe("complianceCalendar", () => {
  ...
  it("status by filing and by date", () => {
    ...
    assert.equal(get("bir_1601c", "2026-08").status, "due_soon"); // Sep 10, 2 days
    assert.equal(get("bir_1601c", "2026-08").daysLeft, 2);
