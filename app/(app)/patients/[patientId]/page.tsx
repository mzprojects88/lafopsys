  ...
  return (
    <div className="flex flex-1 flex-col gap-6">
      <EntityDetailHeader
        ...
        subtitle={`${patient.patientNumber}${canSeeClinical ? ` · ${computeAge(patient.birthDate)} yrs old · ${patient.sex}` : ""}`}
        ...
        metadata={[
          ...
          { label: "Location", value: canSeeClinical ? `${cityLabel}, ${provinceLabel}` : <Restricted /> },
          { label: "Photo Consent", value: patient.photoConsentGranted ? "Granted" : "Not granted" },
        ]}
      />
      ...
      <Tabs defaultValue="overview">
        ...
        <TabsContent value="overview" className="pt-4">
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            ...
            <InfoTile label="Isolation Required" value={patient.isolationRequired ? "Yes (unenforced)" : "No"} />
